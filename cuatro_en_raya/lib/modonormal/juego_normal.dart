...
class JuegoNormal extends StatefulWidget {
  final String gameId;
  final String gameName;

  const JuegoNormal({super.key, required this.gameId, required this.gameName});

  @override
  State<JuegoNormal> createState() => _JuegoNormalState();
}

class _JuegoNormalState extends State<JuegoNormal> {
      ...
      floatingActionButton: Column(
        ...
        children: [
          FloatingActionButton(
            onPressed: reiniciarJuegoNormal,
